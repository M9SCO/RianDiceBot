...
async def calculate(text: str, path_to_grammar: str = "resources/grammar_calculator.lark") -> int: ...


async def roll_dices(text: str, path_to_grammar: str = "resources/grammar_dice.lark") -> list[Dice] | Dice: ...
